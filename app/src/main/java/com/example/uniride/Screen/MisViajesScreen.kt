...
fun MisViajesScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Mis viajes publicados") },
                actions = {
                    IconButton(onClick = {
                        // Para cargar mis viajes necesitamos el id del vehículo del conductor
                        // Se carga vacío si no hay vehículos todavía
                        ...
                        Card(
                            ...
                            Column(modifier = Modifier.padding(16.dp)) {
                                ...
                                Row(
                                    ...
                                    OutlinedButton(
                                        onClick = {
                                            viajeExpandido = if (viajeExpandido == viaje.idViaje) null
                                            else {
    ...
    viajeACancelar?.let { v ->
        AlertDialog(
            ...
            text = { Text("¿Cancelar el viaje de ${v.origen} a ${v.sede?.nombreSede ?: v.destino}? Los pasajeros serán notificados.") },
            confirmButton = {
                Button(
                    onClick = {
            ...
            confirmButton = {
                Button(onClick = {
                    viajeViewModel.editarViaje(
                        v.idViaje,
                        editOrigen, editDestino, editFecha,
